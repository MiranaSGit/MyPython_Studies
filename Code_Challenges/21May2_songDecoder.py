...
# (the number may be zero), and between words(at least one between any pair of neighbouring
#  words), and then the boy glues together all the words, including "WUB", in one string
